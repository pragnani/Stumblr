...
public class NewTextPostController extends ParameterizableViewController {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(NewTextPostController.class);
    ...
    protected ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (!StringUtils.isBlank(request.getParameter("postText"))) {
            ...
            LOGGER.debug("handleRequestInternal PostText{} Title{}", request.getParameter("postText"), request.getParameter("title"));
